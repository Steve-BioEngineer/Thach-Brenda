(function () {
  ...
  document.addEventListener('DOMContentLoaded', () => {
    ...
    /* ---------- Story toggle (max-height) ---------- */
      const storyBtn  = document.getElementById('storyToggleBtn');
      const storyBox  = document.getElementById('loveStory');
      const photoBox  = document.getElementById('photoContainer'); // Optional

      storyBtn?.addEventListener('click', () => {
        const open = storyBox.classList.toggle('expanded');
        photoBox?.classList.toggle('collapsed', !open);
        storyBtn.textContent = open ? 'Hide our story' : 'Read our story';
      }, { passive: true });
